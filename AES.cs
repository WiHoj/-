...
namespace Shifri
{
    public partial class AES : Form
    {
        ...
        {
            messageByte = Encoding.Default.GetBytes(richTextBox1.Text);
            keyByte = Encoding.Default.GetBytes(textBox1.Text);
            byte[] chiperByte = encrypt(messageByte, keyByte);
            richTextBox2.Text = Encoding.Default.GetString(chiperByte);
        }

        private void button2_Click(object sender, EventArgs e)
        {
            messageByte = Encoding.Default.GetBytes(richTextBox2.Text);
            keyByte = Encoding.Default.GetBytes(textBox1.Text);
            byte[] chiperByte = decrypt(messageByte, keyByte);
            richTextBox3.Text = Encoding.Default.GetString(chiperByte);
        }
